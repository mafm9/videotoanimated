...
head_bone =  DestArm.pose.bones["head_fk"]
#jaw_bone =  DestArm.pose.bones["chin_ctrl"]
##lower_face =  DestArm.pose.bones["lowerFaceRig"]
#lower_lip_center =  DestArm.pose.bones["mouth_low_ctrl"]
##lower_lip_center_l =  DestArm.pose.bones["lLipLowerInner"]
##lower_lip_center_r =  DestArm.pose.bones["rLipLowerInner"]
#upper_lip_center =  DestArm.pose.bones["mouth_up_ctrl"]
...
#corner_lip_r =  DestArm.pose.bones["mouth_corner_R"]
#Corner_lip_l =  DestArm.pose.bones["mouth_corner_L"]


##eyebrow_outer_r =  DestArm.pose.bones["rBrowOuter"]
##eyebrow_center_r =  DestArm.pose.bones["brow_ctrl_R"]
##eyebrow_inner_r =  DestArm.pose.bones["rBrowInner"]

##eyebrow_outer_l =  DestArm.pose.bones["lBrowOuter"]
##eyebrow_center_l =  DestArm.pose.bones["brow_ctrl_L"]
##eyebrow_inner_l =  DestArm.pose.bones["lBrowInner"]

#eyelid_l =  DestArm.pose.bones["eyelid_up_ctrl_L"]
#eyelid_r =  DestArm.pose.bones["eyelid_up_ctrl_R"]

#eyelid_lower_l =  DestArm.pose.bones["eyelid_low_ctrl_L"]
#eyelid_lower_r =  DestArm.pose.bones["eyelid_low_ctrl_R"]
